...
class GroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group.save
        format.html { redirect_to(group_tool_url, :notice => 'Group was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @group.update_attributes(params[:group])
        format.html { redirect_to(group_tool_url, :notice => 'Group was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(group_tool_url,:notice => 'Group was successfully deleted.') }
      format.xml  { head :ok }
    end
  end
